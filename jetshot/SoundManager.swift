...
class SoundManager {
    ...
    private func preloadSounds() {
        ...
        shootSound = SKAction.playSoundFileNamed("shoot-sound.mp3", waitForCompletion: false)
        explosionSound = SKAction.playSoundFileNamed("explosion.mp3", waitForCompletion: false)
        powerUpSound = SKAction.playSoundFileNamed("power-up.mp3", waitForCompletion: false)
        coinSound = SKAction.playSoundFileNamed("coin.mp3", waitForCompletion: false)
        hitSound = SKAction.playSoundFileNamed("hit.mp3", waitForCompletion: false)
        gameOverSound = SKAction.playSoundFileNamed("game-over.mp3", waitForCompletion: false)
        levelCompleteSound = SKAction.playSoundFileNamed("level-complete.mp3", waitForCompletion: false)
