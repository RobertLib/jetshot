...
class GameCompletionScene: SKScene {
    ...
    private func createScoreDisplay() -> SKNode {
        ...
        // Score value shadow/glow
        let scoreValueShadow = SKLabelNode(fontNamed: UITheme.Typography.fontBold)
        scoreValueShadow.text = "\(totalScore)"
        scoreValueShadow.fontSize = UITheme.Typography.sizeLarge
        scoreValueShadow.fontColor = UIColor(red: 1.0, green: 0.7, blue: 0.0, alpha: 0.6)
        scoreValueShadow.position = CGPoint(x: 0, y: 16)
