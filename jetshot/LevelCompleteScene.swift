...
class LevelCompleteScene: SKScene {
    ...
    private func setupUI() {
        ...
        let panelHeight = UITheme.Dimensions.panelHeightLevelComplete
    ...
    private func createLevelBadge() -> SKNode {
        ...
        // Outer glow ring
        let glowBadge = SKShapeNode(circleOfRadius: UITheme.Dimensions.badgeGlowRadius)
        glowBadge.fillColor = .clear
        glowBadge.strokeColor = UITheme.Colors.badgeGlow
        glowBadge.lineWidth = UITheme.Dimensions.lineWidthGlow
        container.addChild(glowBadge)

        // Pulse animation for glow
        glowBadge.run(UITheme.createGlowPulseAnimation())

        // Main badge circle
        let badge = SKShapeNode(circleOfRadius: UITheme.Dimensions.badgeRadius)
        badge.fillColor = UITheme.Colors.badgeBackground
        badge.strokeColor = UITheme.Colors.badgeBorder
        badge.lineWidth = UITheme.Dimensions.lineWidthMedium
        container.addChild(badge)

        // Inner highlight
        let highlight = SKShapeNode(circleOfRadius: UITheme.Dimensions.badgeRadius - 3)
        highlight.fillColor = .clear
        highlight.strokeColor = UITheme.Colors.highlightWhiteLight
        highlight.lineWidth = UITheme.Dimensions.lineWidthRegular
        ...
        levelLabel.fontSize = UITheme.Typography.sizeLarge
        levelLabel.fontColor = UITheme.Colors.textPrimary
    ...
    private func createScoreDisplay() -> SKNode {
        let container = UITheme.createScoreBox(
            score: score,
            width: UITheme.Dimensions.scoreBoxWidth,
            height: UITheme.Dimensions.scoreBoxHeightSmall,
            borderColor: UITheme.Colors.primaryGold
        )
