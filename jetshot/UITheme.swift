...
struct UITheme {
    ...
    struct Colors {
        ...
        // Badge colors
        static let badgeBackground = UIColor(red: 0.2, green: 0.4, blue: 0.8, alpha: 1.0)
        static let badgeBorder = UIColor(red: 0.4, green: 0.7, blue: 1.0, alpha: 1.0)
        static let badgeGlow = UIColor(red: 0.4, green: 0.6, blue: 1.0, alpha: 0.6)
    ...
    struct Dimensions {
        ...
        static let panelHeightGameOver: CGFloat = 420
        static let panelHeightLevelComplete: CGFloat = 500

        // Score box sizes
        static let scoreBoxWidth: CGFloat = 200
        static let scoreBoxHeightSmall: CGFloat = 60
        static let scoreBoxHeightMedium: CGFloat = 80

        // Badge sizes
        static let badgeRadius: CGFloat = 35
        static let badgeGlowRadius: CGFloat = 38
    ...
    /// Creates a score display box with consistent styling
    static func createScoreBox(score: Int, width: CGFloat, height: CGFloat, borderColor: UIColor? = nil) -> SKNode {
        ...
        box.fillColor = Colors.panelBoxBackground
        box.strokeColor = borderColor ?? Colors.panelBoxBorder
        box.lineWidth = Dimensions.lineWidthMedium
        container.addChild(box)

        // Inner highlight
        let highlight = SKShapeNode(
            rectOf: CGSize(width: width - 4, height: height - 4),
            cornerRadius: Dimensions.cornerRadiusLarge - 2
        )
        highlight.fillColor = .clear
        highlight.strokeColor = Colors.highlightWhite
        highlight.lineWidth = Dimensions.lineWidthRegular
        highlight.position = CGPoint(x: 0, y: height > 70 ? 2 : 1)
